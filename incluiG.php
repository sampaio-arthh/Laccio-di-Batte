...
<head>
    ...
    <title>Laccio di Batte | Gelato G</title>
</head>
<body>
    <header>
        <div class="top">
    ...
    <div class="main">
        <div class="text-container">
            <h3><b>Monte sua versão da delícia <u>tamanho G</u></b></h3>
        ...
        <div class="container">
            <div class="questions">
                <form method="post" id="form" action="salva.php">
                    ...
                    <br>
                    <label for="sabor4">Escolha um sabor: </label>
    ...
    <style>
        ...
        *{margin:0; padding:0; border:0;}
        ...
        .container{text-align:center;justify-content: space-evenly;}
        ...
        #sabor2{margin:5vh 0;}
        #sabor4{margin-top: 5vh;}
        #tipo{margin: 0 0 5vh 0;}
        h3{text-align: center; font-family: 'Montserrat', sans-serif;font-size: 28px;}
